...
Epidemija COVID-19 se trenutno razširja v pandemijo. Ljudje so v samoizolaciji, vsi čutimo posledice nekateri direktno, drugi bolj posredno. Projekt smo pričeli s kreiranjem podatkovne množice, ki smo jo transformirali v uporabno obliko. Poleg tega smo uporabili nekatere podatkovne množice iz Kaggle za natančne podatke in statistike o širjenju okužb, ozdravelih ter smrtnih žrtev.
